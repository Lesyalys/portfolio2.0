        ...
        <ul className="[&>li]:pb-2 [&>li]:last:pb-0">
          <li>
            <p className="flex items-center gap-1">
              <span className=" ph--student bg-[#1976d2] text-white p-1 rounded-lg"></span>
              I am a 3rd year student at
              <a
                target="_blank"
                href="https://nvsu.ru/"
                className="hover:text-[#1976d2] transition-colors border-2 border-[#1976d2] rounded-2xl p-1"
              >
          ...
          <li>
            <p className="flex items-center gap-1">
              ...
              <a
                ...
                className="hover:text-[#00db00] transition-colors border-2 border-[#00db00] rounded-2xl p-1"
              >
                Sberbank 21.
              </a>
            </p>
